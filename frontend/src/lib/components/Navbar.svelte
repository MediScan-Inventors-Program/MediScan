...
<nav class="bg-primary px-6 sm:px-32 py-3">
    <div class="container flex flex-wrap justify-between items-center mx-auto">
        <a href="/" class="flex">
            <img src="/imgs/brand.png" alt="MediScan Logo" class="h-12">
            <span class="self-center text-2xl font-medium whitespace-nowrap px-6 text-background tracking-wide font-poppins">MediScan</span>
        </a>
